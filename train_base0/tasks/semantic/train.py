...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--arch_cfg', '-ac',
        type=str,
        default="/public/home/meijilin/code/mjl/SalsaNext/salsanext.yml",
        help='Architecture yaml cfg file. See /config/arch for sample. No default!',
    )
    parser.add_argument(
        '--data_cfg', '-dc',
        type=str,
        default='/public/home/meijilin/code/mjl/SalsaNext/train_base0/tasks/semantic/config/labels/semantic-kitti.yaml',
    ...
    trainer = Trainer(ARCH, DATA, FLAGS.dataset, FLAGS.log, FLAGS.group, FLAGS.pretrained,FLAGS.uncertainty)
    trainer.train()
